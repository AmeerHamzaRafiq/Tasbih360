      ...
      <div className="container mx-auto px-4 py-6">
            ...
            <CardContent>
              {chartData.length > 0 ? (
                <div className="text-2xl font-bold">
                  {
                    Object.entries(groupedByDate).reduce(
                      (max, [date, data]) =>
                        data.current > max.current
                          ? { date, current: data.current }
                          : max,
                      { date: "", current: 0 }
                    ).date
                  }
        ...
        <Card className="mb-6">
          ...
          <CardContent>
            <div className="h-[300px] sm:h-[400px]">
                              ...
                              {/*graph padding problem */}

              <ResponsiveContainer className="ml-[-30px]  "  width="100%" height="100%">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between">
            <CardTitle className="text-xl font-bold">Recent Progress</CardTitle>
            <Button
              variant="destructive"
              size="sm"
              onClick={() => {
                        ...
                        >
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <Button
                              variant="ghost"
                              size="sm"
                              className="text-red-500 bg-slate-50 hover:text-red-700"
                              onClick={() => {
